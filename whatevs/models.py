...
class EventStatus(models.Model):
    ...
    class Meta:
        db_table = 'events_manager.event_status'
...
class ActivityStatus(models.Model):
    ...
    class Meta:
        db_table = 'events_manager.activity_status'
...
class Activity(models.Model):
    ...
    class Meta:
        db_table = 'events_manager.activity'
...
class Message(models.Model):
    ...
    class Meta:
        db_table = 'events_manager.message'
